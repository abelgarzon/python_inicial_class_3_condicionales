...
temperatura_1 = float(input('ingrese el valor del sensor 1:\n'))
temperatura_2 = float(input('ingrese el valor del sensor 2:\n'))
temperatura_3 = float(input('ingrese el valor del sensor 3:\n'))

temperatura_max = 0
temperatura_min = 0

# calculamos temperatura promedio
temperatura_promedio = (temperatura_1 + temperatura_2 + temperatura_3) / 3

# identificanndo temperatura máxima
...
# identificanndo temperatura mínima
if temperatura_1 <= temperatura_2 and temperatura_1 <= temperatura_3:
...
#Al finalizar, imprimir en pantalla las variables temperatura_max, temperatura_min y temperatura_promedio
print(f'temperatura_max = {temperatura_max:.2f}\ntemperatura_min = {temperatura_min:.2f}\ntemperatura_promedio = {temperatura_promedio:.2f}')
