...
temperatura_1 = float(input('ingrese el valor del sensor de temperatura 1: '))
temperatura_2 = float(input('ingrese el valor del sensor de temperatura 2: '))
temperatura_3 = float(input('ingrese el valor del sensor de temperatura 3: '))

temperatura_total = temperatura_1 + temperatura_2 + temperatura_3
temperatura_promedio = temperatura_total / 3

# Al final imprimir en pantalla la variable temperatura_promedio
print(f'temperatura_promedio = {temperatura_promedio:.2f}')
